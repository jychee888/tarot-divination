    ...
    <div className="flex items-center space-x-2">
      {session ? (
        ...
        <button
          ...
          className="chinese-title-bakudai border-2 border-amber-400 bg-transparent hover:bg-amber-500/20 text-amber-300 hover:text-amber-200 px-8 py-2 rounded-full transition-all duration-300 transform hover:scale-105">
          登入
        </button>
      )}
    </div>
