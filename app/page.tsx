        ...
        <div className="relative z-50 w-full">
          ...
          <div className="relative z-50 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/daily">
              <Button
                variant="outline"
                className="chinese-title-bakudai border border-amber-500/50 bg-amber-950/20 hover:bg-amber-500/10 text-amber-200 hover:text-amber-100 text-lg px-8 py-6 rounded-full transition-all duration-300 transform hover:scale-105 backdrop-blur-sm"
              >
